      ...
      <Grid container justifyContent="space-between" alignItems="center">
        <Box display="flex" flexDirection="row">
          ...
          <IconButton onClick={toggleBackgroundMusic}>
            <Tooltip title={isBackgroundMusicOn ? "Turn off background music" : "Turn on background music"}>
              <span className={getModeButtonClassName(isBackgroundMusicOn)}>
                {isBackgroundMusicOn ? (
        ...
        {!isSiteInfoDisabled && (
          <Box display="flex" flexDirection="row" alignItems="center" gap={1}>
            ...
            <span style={{ fontSize: '12px', marginRight: '8px' }}>
              View your progress · Project from 12-Peter Group 5
            </span>
          </Box>
        )}
        {isBottomLogoEnabled && (
