...
const MusicPlayer = ({ disabled, isZenMode }) => {
  const height = isZenMode ? "80" : "152";

  const players = {
    spotify:
      '<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/0ZqRlZTgNbQgynrHdxzLHp?utm_source=generator&autoplay=1" width="100%" height=' +
      height +
