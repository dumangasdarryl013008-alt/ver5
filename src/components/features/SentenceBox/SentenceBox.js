...
import {
  ...
  TAGALOG_SENTENCE_MODE_TOOLTIP_TITLE,
} from "../../../constants/Constants";
            ...
            <Box display="flex" flexDirection="row">
              ...
              {menuEnabled && (
                <>
                  ...
                  <IconButton
                    onClick={() => {
                      reset(sentencesCountConstant, TAGALOG_MODE, false);
                    }}
                  >
                    <Tooltip title={TAGALOG_SENTENCE_MODE_TOOLTIP_TITLE}>
                      <span
                        className={getLanguageButtonClassName(TAGALOG_MODE)}
                      >
                        tgl
                      </span>
                    </Tooltip>
