...
right: -2px;
bottom: -2px;
background: linear-gradient(45deg, #FFE0B2, #FF9800, #FFE0B2);
border-radius: 20px;
opacity: 0;
z-index: -1;
...
.bottomBar .MuiIconButton-root {
border-radius: 50%;
transition: all 0.3s ease;
}

.bottomBar .MuiIconButton-root:hover {
transform: scale(1.1);
background-color: rgba(255, 152, 0, 0.1);
}

.zen-button, .zen-button-deactive {
border-radius: 50%;
padding: 8px;
transition: all 0.3s ease;
}

.zen-button:hover, .zen-button-deactive:hover {
transform: rotate(5deg) scale(1.1);
}

.active-game-mode-button, .inactive-game-mode-button {
border-radius: 16px;
padding: 6px 12px;
transition: all 0.3s ease;
...
.inactive-game-mode-button:hover {
border-color: #FFE0B2;
